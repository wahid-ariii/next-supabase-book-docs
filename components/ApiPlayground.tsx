...
function MethodBadge(method: string) {
	...
	return (
		<div className={`font-medium px-1.5 rounded-lg ${color}`}>{method}</div>
	);
}
		...
		<div className="border dark:border-neutral-800 p-4 rounded-md mt-8">
			<div className={`flex items-center gap-4 ${param ? "-mb-2" : "mb-4"}`}>
				...
				<a
					...
					target="_blank"
					className={cn(
						"font-medium text-neutral-700 dark:text-neutral-200 m-0 hover:underline transition-all duration-200",
			...
			{param ? (
				<div className="-mb-2 mt-6">
					<div className="border-b dark:border-b-neutral-800 mb-5">
						<button
							className={cn(
								"pb-2 text-sm text-green-600 font-medium border-b-2 border-b-green-600",
								"focus-visible:!outline-none focus-visible:!ring-2 focus-visible:!ring-green-500 focus-visible:ring-offset-0"
							)}
						>
							Query
					...
					<div className="flex flex-wrap gap-3 items-center">
						...
						<input
							...
							type="text"
							className={cn(
								"bg-[#f7f7f7] border border-neutral-300 dark:border-neutral-700 dark:bg-[#111] py-0.5 px-2 rounded-md",
								"focus-visible:!outline-none focus-visible:!ring-2 focus-visible:!ring-green-500 focus-visible:ring-offset-0"
							)}
						/>
					</div>
			...
			<button
				...
				className={cn(
					...
					"transition-all duration-300 text-white rounded disabled:cursor-not-allowed",
