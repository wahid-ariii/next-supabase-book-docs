		...
		return (
			<div key={index + 1} className="my-8">
				<h3 className="text-2xl text-neutral-800 font-medium">
					<Link
						href={page.route}
						className="text-neutral-900 dark:text-white hover:text-orange-500 dark:hover:text-orange-500 transition-all no-underline"
					>
				...
				<p className="opacity-80 !mt-0 pt-3">
					...
					<Link
						href={page.route}
						className="text-orange-500 hover:text-orange-600 hover:underline transition-all duration-300"
					>
						{more + " ➔"}
					</Link>
				</p>
