...
const config = {
  ...
  project: {
    link: 'https://github.com/wahid-ari/next-supabase-book-docs',
  },
  // chat: {
  ...
  useNextSeoProps() {
    ...
    if (route !== '/') {
      return {
        titleTemplate: '%s – MyBook API Docs'
      }
    }
  },
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta name="og:title" content={`${title} - MyBook API Docs`} />
        <meta name="description" content={`${title} - Discover MyBook API Docs`} />
        <meta name="og:description" content={`${title} - Discover MyBook API Docs`} />
  ...
  docsRepositoryBase: 'https://github.com/wahid-ari/next-supabase-book-docs/tree/master/',
  banner: {
    key: 'banner',
    text: (
    ...
    text: () => {
      return (
        <div>
          ...
          <p className="mt-4 text-sm text-center md:text-left">© 2022 MyBook.</p>
        </div>
      )
    }
  },
